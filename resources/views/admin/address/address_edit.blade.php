            ...
            <div class="col-12">
                <div class="card top-selling overflow-auto">
                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="{{route('upadte_address.update')}}" method="POST"
                            ...
                            <div class="col-md-6">
                                <label>Address</label>
                                <textarea rows="3" cols="" name="address" class="form-control"
                                    placeholder="Enter  address">{{$data[0]->address}}</textarea>
                            </div>
