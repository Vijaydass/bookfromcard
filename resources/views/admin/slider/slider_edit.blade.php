        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card top-selling overflow-auto">
                    ...
                    <div class="filter">
                        <a href="{{url('own-cms/sliders')}}" class="btn btn-primary btn-sm">Slider</a>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="{{route('upadte_slider.update')}}"  method="POST" enctype="multipart/form-data">
                            @csrf  
                                <div class="col-md-6">
